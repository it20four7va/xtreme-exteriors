        ...
        <section id="clients" class="clients">
            <div class="container">
                ...
                <div class="row no-gutters clients-wrap clearfix wow fadeInUp">
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="client-logo">
                            <img src="<?php echo get_template_directory_uri();?>/assets/img/clients/client-7.png" class="img-fluid" alt="">
                        </div>
                    </div>

                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="client-logo">
                            <img src="<?php echo get_template_directory_uri();?>/assets/img/clients/client-8.png" class="img-fluid" alt="">
                        </div>
                    </div>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="<?php echo get_template_directory_uri();?>/assets/img/gallery/gallery-1.jpg" class="galleery-lightbox" data-gallery="gallery-item">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/gallery/gallery-1.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="<?php echo get_template_directory_uri();?>/assets/img/gallery/gallery-2.jpg" class="galleery-lightbox" data-gallery="gallery-item">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/gallery/gallery-2.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="<?php echo get_template_directory_uri();?>/assets/img/gallery/gallery-3.jpg" class="galleery-lightbox" data-gallery="gallery-item">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/gallery/gallery-3.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="<?php echo get_template_directory_uri();?>/assets/img/gallery/gallery-4.jpg" class="galleery-lightbox" data-gallery="gallery-item">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/gallery/gallery-4.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="<?php echo get_template_directory_uri();?>/assets/img/gallery/gallery-5.jpg" class="galleery-lightbox" data-gallery="gallery-item">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/gallery/gallery-5.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="<?php echo get_template_directory_uri();?>/assets/img/gallery/gallery-6.jpg" class="galleery-lightbox" data-gallery="gallery-item">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/gallery/gallery-6.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="<?php echo get_template_directory_uri();?>/assets/img/gallery/gallery-7.jpg" class="galleery-lightbox" data-gallery="gallery-item">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/gallery/gallery-7.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="<?php echo get_template_directory_uri();?>/assets/img/gallery/gallery-8.jpg" class="galleery-lightbox" data-gallery="gallery-item">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/gallery/gallery-8.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
